...
// Sistema de reservas desabilitado permanentemente
      ...
      `}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full">
          <div className="flex items-center justify-between h-full">
            ...
            {/* Desktop Actions - Oculto no mobile */}
            <div className="hidden lg:flex items-center space-x-2">
              {/* Menu PDF Link */}
              <a
            ...
            {/* Mobile Actions - Apenas botões essenciais */}
            <div className="flex lg:hidden items-center space-x-2">
              ...
              {user ? (
                ...
                <Link prefetch={true}
                  href={`/${currentLocale}/login`}
                  className="
                    relative px-3 py-2 rounded-xl font-semibold transition-all duration-300 hover:scale-105
                    bg-amber-600 hover:bg-amber-700 text-white shadow-lg text-sm
                  "
                >
                  {t('header.login')}
                </Link>
