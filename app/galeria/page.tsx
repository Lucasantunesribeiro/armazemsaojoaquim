...
const categories = [
  { value: 'all', label: 'Todas as Categorias', icon: Palette },
  { value: 'SANTA_TERESA_HISTORICA', label: 'Santa Teresa Histórica', icon: MapPin },
  { value: 'RIO_ANTIGO', label: 'Rio Antigo', icon: Calendar },
  { value: 'ARTE_CONTEMPORANEA', label: 'Arte Contemporânea', icon: Palette },
  { value: 'RETRATOS_BAIRRO', label: 'Retratos do Bairro', icon: User }
]
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-slate-600 dark:text-slate-300 mb-6 max-w-3xl mx-auto">
              Memórias de Santa Teresa em cada pincelada. Descubra a história do bairro boêmio 
              através do olhar de artistas locais e contemporâneos.
            </p>
            <div className="flex items-center justify-center space-x-2 text-amber-700 dark:text-amber-300">
              <MapPin className="w-5 h-5" />
              <span className="font-semibold">"En esta casa tenemos memoria"</span>
            </div>
          </div>
          ...
          <div className="bg-white dark:bg-slate-800 rounded-2xl max-w-4xl max-h-[90vh] overflow-y-auto">
            <div className="grid md:grid-cols-2 gap-6 p-6">
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-4">
                  <div>
                    <h4 className="font-semibold text-slate-900 dark:text-white mb-2">Descrição</h4>
                    <p className="text-slate-700 dark:text-slate-300">{selectedArtwork.description}</p>
                  </div>
                  
                  {selectedArtwork.historical_context && (
                    <div>
                      <h4 className="font-semibold text-slate-900 dark:text-white mb-2">Contexto Histórico</h4>
                ...
                <div className="flex space-x-3 pt-4">
                  ...
                  >
                    <ShoppingCart className="w-4 h-4" />
                    <span>{cart.includes(selectedArtwork.id) ? 'No Carrinho' : 'Adicionar ao Carrinho'}</span>
                  </Button>
                  <Button
                    variant="outline"
