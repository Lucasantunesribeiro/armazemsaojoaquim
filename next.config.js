...
const nextConfig = {
  ...
  images: {
    unoptimized: process.env.NODE_ENV === 'production', // Disable optimization in production for Netlify compatibility
    ...
    loaderFile: process.env.NODE_ENV === 'production' ? './lib/image-loader.js' : undefined,
